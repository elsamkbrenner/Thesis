...
```{r beta_div_neutral_centroids_region,comment="", echo=TRUE}
#### Create centroids
...
Adonis
```{r Adonis, comment="", echo=TRUE}
# adonis_result <- adonis(beta_div_neutral_dist ~ region, data = beta_div_neutral_nmds)

# Print the Adonis test result
# print(adonis_result)

# Extract and print the p-value
# p_value <- adonis_result$aov.tab$`Pr(>F)`
# print(p_value)
