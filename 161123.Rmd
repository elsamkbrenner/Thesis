...
columns_to_select <- setdiff(names(iferred_species), "region")

# Perform left join excluding the 'region' column
all_metadata <- dplyr::left_join(all_metadata, iferred_species %>% select(all_of(columns_to_select)), by = "sample")
