...
```
So from this information, we know that at the there are 8 phyla that are significantly differently abundant between Ittoq and Daneborg according to LinDA
```{r}
tax <- data.frame(physeq@tax_table) %>%
  rownames_to_column(., "taxon")
