...
leveneTest(q1 ~ region, alpha_div_N)
...
# Results: p = 0.4869263	
# THEREFORE Neutral alpha diversity is NOT have statistically significant differences between Ittoq and Daneborg
```
...
#### NMDS
hill_pair_dis <- hillpair(data=count_filtered,q=1)
