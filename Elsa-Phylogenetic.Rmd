...
```{r beta_div_neutral_dist dataframe, comment="", echo=TRUE, message=FALSE, warning=FALSE, results='hide'}
...
Showcasing the NA issue in list2dist
```{r head distances dataframe, comment="", echo=TRUE, message=FALSE, warning=FALSE}
head(beta_div_neutral_dist)
```
I have printed this to display that the dataframe in beta_div_neutral_dist correctly selects values, before list2dist has lots of NAs. 

```{r beta_div_neutral_dist, comment="", echo=TRUE, message=FALSE, warning=FALSE, results='hide'}
...
Then, the list2dist step yields lots of NAs:
```{r print list2dist, comment="", echo=TRUE, message=FALSE, warning=FALSE}
print(beta_div_neutral_dist)
```
